...
- **ai-ku-core-pro**: Penalaran logis mendalam (2M Token).
- **ai-ku-core-max**: Analisis data masif & refleksi (10M Token).
...
- **ai-ku-forge-lite**: Perbaikan bug, pembuatan skrip, & optimasi ringan.
- **ai-ku-forge-titan**: Refactoring seluruh proyek & arsitektur sistem kompleks.

## 🔍 Intelligence Scout (Search Models)
- **ai-ku-scout-lite**: Berita terkini & fakta umum.
- **ai-ku-scout-deep**: Riset teknis mendalam & dokumentasi.
